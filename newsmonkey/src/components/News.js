...
export default class News extends Component {
    ...
    async componentDidMount() {
        ...
        console.log(apiKey);
        let link = `https://newsapi.org/v2/top-headlines?country=${country}&category=${category}&apiKey=b042499871734997bf112f2a95dd8242`;
    ...
    nextPage = async () => {
        ...
        setProgress(10);
        let link = `https://newsapi.org/v2/top-headlines?country=${country}&category=${category}&apiKey=b042499871734997bf112f2a95dd8242&page=${this.state.page + 1}`;
        let data = await fetch(link);
        let parsedData = await data.json();
        this.setState({
            data: parsedData,
        ...
        return (
            ...
            <>
                ...
                > */}
                    {this.state.loading ? <Spinner/> :
                    <div>
                        <h1 className="headtitle">News Monkey: Top Headlines from {category}</h1>
                        <div className='news'>
                            {
